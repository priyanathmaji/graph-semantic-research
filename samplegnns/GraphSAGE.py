...
class GraphSAGE(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=3, dropout=.1):
        ...
        # Convolution List
        conv_list = []
        conv_list.append(SAGEConv(in_channels, hidden_channels))
        for _ in range(num_layers-2):
             conv_list.append(SAGEConv(hidden_channels, hidden_channels))
        conv_list.append(SAGEConv(hidden_channels, out_channels))
